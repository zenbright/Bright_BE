...
export function handleErrorReponseAPI(error) {
    ...
    try {
        ...
        const resMessage = Array.isArray(resData === null || resData === void 0 ? void 0 : resData.errors) ? (_c = resData.errors[0]) === null || _c === void 0 ? void 0 : _c.param : ERROR_CODE.INTERNAL_SERVER_ERROR;
